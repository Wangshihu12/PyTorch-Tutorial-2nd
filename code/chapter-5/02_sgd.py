...
@date       : 2022-06-01
@brief      : SGD使用教程
@description: 演示完整的深度学习模型训练流程，使用SGD优化器
             包括数据加载、模型构建、优化器设置和训练循环的完整实现
             展示如何将理论转化为实际的代码实现
"""
import os
import torch
...
def main():
    ...
    train_loader = DataLoader(dataset=train_data, batch_size=2)  # 批次大小为2
